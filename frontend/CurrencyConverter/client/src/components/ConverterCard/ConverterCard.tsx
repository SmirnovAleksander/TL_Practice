    ...
    <div className={styles.card}>
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.right}>
          <PriceGraph data={pricesState.data ?? []} isLoading={pricesState.isLoading} error={pricesState.error} />
          <PeriodSwitcher period={period} handlePeriodChange={handlePeriodChange} />
        </div>
      </div>
      ...
      <MoreAboutGroup key={`${from}-${to}`} fromCurrency={fromCurrency} toCurrency={toCurrency} />
